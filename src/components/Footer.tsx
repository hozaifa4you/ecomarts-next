                        ...
                        <div className="single-footer-widget">
                           ...
                           <div className="footer-content">
                              <p>
                                 ...
                                 ullamcorper laoreet neque, a lacinia curabitur
                                 lacinia mollis
                              </p>
                     ...
                     >
                        <div className="single-footer-widget">
                           ...
                           <ul className="list-area">
                              ...
                              <li>
                                 <Link className="style1" href="/contact">
                                    <i className="fa-solid fa-chevrons-right"></i>
                                    Opening Hours
                                 </Link>
                              </li>
            ...
            <div className="footer-bottom">
               <div className="container">
                  ...
                  >
                     ...
                     <ul
                        className="credit-card-logo wow fadeInRight"
                        data-wow-delay=".5s"
                     >
                        <li>
                           <Link href="#">
                        ...
                        <li>
                           <Link href="#">
                              <Image
                                 width={38}
                                 height={23}
                                 src="/images/logo/mastercard-logo.png"
                                 alt="EcomArts"
                              />
                           </Link>
                        </li>
                        <li>
                           <Link href="#">
                              <Image
                                 height={16}
                                 width={38}
                                 src="/images/logo/payoneer-logo.png"
                                 alt="EcomArts"
                              />
                           </Link>
                        </li>
                        <li>
                           <Link href="#">
                              <Image
                                 width={44}
                                 height={18}
                                 src="/images/logo/affirm-logo.png"
                                 alt="img"
                              />
                           </Link>
                        </li>
